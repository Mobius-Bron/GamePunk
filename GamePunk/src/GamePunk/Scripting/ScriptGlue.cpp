...
#include "GamePunk/Core/Input.h"

#include "GamePunk/Scene/Scene.h"
#include "GamePunk/Scene/Entity.h"

#include "GamePunk/Physics/Physics2D.h"
...
#define HZ_ADD_INTERNAL_CALL(Name) mono_add_internal_call("Hazel.InternalCalls::" #Name, Name)
	...
	{
		GP_CORE_WARN("Value: {0}", *parameter);
	...
	static bool Entity_HasComponent(UUID entityID, MonoReflectionType* componentType)
	{
		...
		GP_CORE_ASSERT(scene);
		Entity entity = scene->GetEntityByUUID(entityID);
		GP_CORE_ASSERT(entity);

		MonoType* managedType = mono_reflection_type_get_type(componentType);
		GP_CORE_ASSERT(s_EntityHasComponentFuncs.find(managedType) != s_EntityHasComponentFuncs.end());
	...
	static MonoString* TextComponent_GetText(UUID entityID)
	{
		...
		Entity entity = scene->GetEntityByUUID(entityID);
		GP_CORE_ASSERT(entity);
		GP_CORE_ASSERT(entity.HasComponent<TextComponent>());
